        ...
        <nav class="bg-gray-800">
            ...
            <div class="md:hidden" v-show="isOpen">
                <div class="px-2 pt-2 pb-3 space-y-1 sm:px-3">
                    ...
                    <inertia-link v-if="$page.user.level!=='TECHNICAL'" :href="route('dashboard.profiles.list')"
                    ...
                    <inertia-link
                        v-if="$page.user.level==='SUPERUSER' || $page.user.level==='ADMIN' || $page.user.level==='AGENT' || $page.user.level==='OFFICE'"
                    ...
                    <inertia-link v-if="$page.user.level==='SUPERUSER' || $page.user.level==='ADMIN'" :href="route('dashboard.reports.list')"
                                  class="text-gray-300 hover:bg-gray-700 hover:text-white block px-2 py-2 rounded-md text-base font-medium">
                        <svg class="inline" style="width:24px;height:24px" viewBox="0 0 24 24">
                            <path fill="currentColor"
