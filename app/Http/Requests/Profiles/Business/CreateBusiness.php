...
class CreateBusiness extends FormRequest
{
    ...
    public function rules()
    {
        $validationArray = [
            ...
            'business_type' => 'required|in:physical,physicalVirtual,virtual',
            'business_category_code' => 'required|exists:business_categories,id',
            'business_subCategory_code' => 'required|exists:business_sub_categories,id',
            'business_type' => 'required|in:physical,physicalVirtual,virtual',
