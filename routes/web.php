...
//    [AuthenticatedSessionController::class, 'destroy']
    ...
    if ($isLoginByAdmin) {
        ...
        $request->session()->forget('loginByAdmin');
...
Route::middleware(['auth'])
    ->get('dashboard/users/{user}/login', [\App\Http\Controllers\LoginAsUserController::class, 'login'])
    ->name('dashboard.users.login');

Route::middleware(['auth:sanctum', 'verified', CheckUserStatus::class])
    ->prefix('dashboard')
    ->name('dashboard.')
